...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://habit-flow-backend-delta.vercel.app/api/auth/register', {
        method: 'POST',
        headers: {
  ...
  const handleGoogleSignup = () => {
    window.location.href = 'https://habit-flow-backend-delta.vercel.app/api/auth/google';
  };
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          {/* <button
            ...
            type="button"
            className="w-full bg-white border-2 border-gray-300 text-gray-700 py-3 rounded-lg hover:bg-gray-50 transition-colors duration-200 font-semibold flex items-center justify-center space-x-2"
          >
